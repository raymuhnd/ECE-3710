...
//
// ReadAddressA and ReadAddressB are the 4-bit control signals for the two
// 16-to-1 read MUXes. The write-address decoder produces an explicit enable
// for each of the sixteen registers.
//
// The five ALU flags are stored in five additional flip-flops. Therefore,
// synthesis should create 256 register bits for R0-R15 and 5 flag bits.
module RegFile (
    input  wire        Clock,
    input  wire        Reset,
    ...
    // One-hot register enables generated by the write-address decoder.
    ...
    // Read port A: the address selects one register through a 16-to-1 MUX.
    ...
    // Read port B: independent from read port A.
